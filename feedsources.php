...
$feeds_wp_json = [
    ...
    'AIESEC in BINUS' => 'https://student-activity.binus.ac.id/aiesec/wp-json/wp/v2/posts?per_page=75&_embed',
    'Architecture - Faculty of Engineering' => 'https://architecture.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'B-Preneur' => 'https://student-activity.binus.ac.id/b-preneur/wp-json/wp/v2/posts?per_page=75&_embed',
    'Bersama Dalam Musik (BDM)' => 'https://student-activity.binus.ac.id/bdm/wp-json/wp/v2/posts?per_page=75&_embed',
    'Bina Nusantara Computer Club (BNCC)' => 'https://student-activity.binus.ac.id/bncc/wp-json/wp/v2/posts?per_page=75&_embed',
    'Bina Nusantara Finance Club (BNFC)' => 'https://student-activity.binus.ac.id/financeclub/wp-json/wp/v2/posts?per_page=75&_embed',
    'Bina Nusantara Mandarin Club (BNMC)' => 'https://student-activity.binus.ac.id/bnmc/wp-json/wp/v2/posts?per_page=75&_embed',
    'Bina Nusantara Swimming Club (BASIC)' => 'https://student-activity.binus.ac.id/basic/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Business International Club (BIC)' => 'https://student-activity.binus.ac.id/bic/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Business School (BBS)' => 'https://bbs.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Entrepreneurship Center (BEC)' => 'https://binus.ac.id/entrepreneur/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Game Development Club (BGDC)' => 'https://student-activity.binus.ac.id/bgdc/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Association of Information System (BASIS)' => 'https://student-activity.binus.ac.id/basis/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Camera In Action (CIA)' => 'https://student-activity.binus.ac.id/cia/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Community in Christ (CIC)' => 'https://student-activity.binus.ac.id/cic/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Computer Science Society (BINARY)' => 'https://student-activity.binus.ac.id/binary/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Dance Club (BIDC)' => 'https://student-activity.binus.ac.id/bidc/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Marketing Club (BIMARC)' => 'https://student-activity.binus.ac.id/bimarc/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS International Office' => 'https://io.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Northumbria School of Design (BNSD)' => 'https://bnsd.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Square' => 'https://binus.ac.id/binussquare/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Square Student Committee (BSSC)' => 'https://student-activity.binus.ac.id/bssc/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS Student Learning Community (BSLC)' => 'https://student-activity.binus.ac.id/bslc/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS TV' => 'https://binus.tv/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS TV Club' => 'https://student-activity.binus.ac.id/binustvclub/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS University' => 'https://binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'BINUS English Club (BNEC)' => 'https://student-activity.binus.ac.id/bnec/wp-json/wp/v2/posts?per_page=75&_embed',
    'Business Law - Faculty of Humanities' => 'https://business-law.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'BVoice Radio' => [
        'https://www.bvoiceradio.com/wp-json/wp/v2/posts?per_page=75&_embed',
        'https://student-activity.binus.ac.id/bvoice/wp-json/wp/v2/posts?per_page=75&_embed',
    ],
    'Character Building Development Center (CBDC)' => 'https://binus.ac.id/character-building/wp-json/wp/v2/posts?per_page=75&_embed',
    'Chinese Literature - Faculty of Humanities' => 'https://chinese.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Civil Engineering - Faculty of Engineering' => 'https://civil-eng.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Computer Engineering - Faculty of Engineering' => 'https://comp-eng.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Cyber Security Community (CSC)' => 'https://student-activity.binus.ac.id/csc/wp-json/wp/v2/posts?per_page=75&_embed',
    'DKV Animation' => 'https://animation.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'DKV Creative Advertising' => 'https://ca.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'DKV New Media' => 'https://dkv.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'English Literature - Faculty of Humanities' => 'https://english.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Faculty of Engineering' => 'https://engineering.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Fast Response Community (FARCO)' => 'https://student-activity.binus.ac.id/farco/wp-json/wp/v2/posts?per_page=75&_embed',
    'Filemagz by BNCC' => 'https://www.filemagz.com/wp-json/wp/v2/posts?per_page=75&_embed',
    'Food Technology - Faculty of Engineering' => 'https://foodtech.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Akuntansi (HIMA)' => 'https://student-activity.binus.ac.id/hima/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Arsitektur (HIMARS)' => 'https://student-activity.binus.ac.id/himars/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Business Law (HIMSLAW)' => 'https://student-activity.binus.ac.id/himslaw/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Desain Interior (HIMDI)' => 'https://student-activity.binus.ac.id/himdi/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Desain Komunikasi Visual (HIMDKV)' => 'https://student-activity.binus.ac.id/himdkv/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Hotel Management (HOME)' => 'https://student-activity.binus.ac.id/home/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Hubungan Internasional (HIMHI)' => 'https://student-activity.binus.ac.id/himhi/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Komputerisasi Akuntansi (HIMKA)' => 'https://student-activity.binus.ac.id/himka/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Management (HIMME)' => 'https://student-activity.binus.ac.id/himme/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Communication Department (HIMMCOMM)' => 'https://student-activity.binus.ac.id/himmcomm/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Matematika (HIMMAT)' => 'https://student-activity.binus.ac.id/himmat/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Pariwisata (HIMPAR)' => 'https://student-activity.binus.ac.id/himpar/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Pendidikan Guru Sekolah Dasar (HIMPGSD)' => 'https://student-activity.binus.ac.id/himpgsd/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Psikologi (HIMPSIKO)' => 'https://student-activity.binus.ac.id/himpsiko/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Sastra Inggris (HIMSI)' => 'https://student-activity.binus.ac.id/himsi/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Sastra Jepang (HIMJA)' => 'https://student-activity.binus.ac.id/himja/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Sastra Mandarin (HIMANDA)' => 'https://student-activity.binus.ac.id/himanda/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Sistem Informasi (HIMSISFO)' => 'https://student-activity.binus.ac.id/himsisfo/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Sistem Komputer (HIMTEK)' => 'https://student-activity.binus.ac.id/himtek/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Statistika (HIMSTAT)' => 'https://student-activity.binus.ac.id/himstat/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Teknik Industri (HIMTRI)' => 'https://student-activity.binus.ac.id/himtri/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Teknik Informatika (HIMTI)' => 'https://student-activity.binus.ac.id/himti/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Teknik Sipil (HIMTES)' => 'https://student-activity.binus.ac.id/himtes/wp-json/wp/v2/posts?per_page=75&_embed',
    'Himpunan Mahasiswa Teknologi Pangan (HIMFOODTECH)' => 'https://student-activity.binus.ac.id/himfoodtech/wp-json/wp/v2/posts?per_page=75&_embed',
    'Hotel Management - Faculty of Economic & Communication' => 'https://hotel-management.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Industrial Engineering - Faculty of Engineering' => 'https://ie.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'International Marketing Community of BINUS University (IMCB)' => 'https://student-activity.binus.ac.id/imcb/wp-json/wp/v2/posts?per_page=75&_embed',
    'International Relations - Faculty of Humanities' => 'https://ir.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'ISACA Student Group (ISG)' => 'https://student-activity.binus.ac.id/isgbinus/wp-json/wp/v2/posts?per_page=75&_embed',
    'Japanese Literature - Faculty of Humanities' => 'https://japanese.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Keluarga Besar Mahasiswa Khonghucu (KBMK)' => 'https://student-activity.binus.ac.id/kbmk/wp-json/wp/v2/posts?per_page=75&_embed',
    'Keluarga Mahasiswa Buddha Dhammavaddhana (KMBD)' => 'https://student-activity.binus.ac.id/kmbd/wp-json/wp/v2/posts?per_page=75&_embed',
    'Keluarga Mahasiswa Hindu (KMH)' => 'https://student-activity.binus.ac.id/kmh/wp-json/wp/v2/posts?per_page=75&_embed',
    'Keluarga Mahasiswa Katolik (KMK)' => 'https://student-activity.binus.ac.id/kmk/wp-json/wp/v2/posts?per_page=75&_embed',
    'Klub Seni Fotografi Bina Nusantara (KLIFONARA)' => 'https://student-activity.binus.ac.id/klifonara/wp-json/wp/v2/posts?per_page=75&_embed',
    'Mahasiswa Bina Nusantara Pencinta Alam (SWANARAPALA)' => 'https://student-activity.binus.ac.id/swanarapala/wp-json/wp/v2/posts?per_page=75&_embed',
    'Majelis Ta’lim (MT) Al-Khawarizmi' => 'https://student-activity.binus.ac.id/mt/wp-json/wp/v2/posts?per_page=75&_embed',
    'Marketing & Mass Communication - Faculty of Economic & Communication' => 'https://communication.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Nippon Club' => 'https://student-activity.binus.ac.id/nc/wp-json/wp/v2/posts?per_page=75&_embed',
    'Paduan Suara Mahasiswa Bina Nusantara (PARAMABIRA)' => 'https://student-activity.binus.ac.id/paramabira/wp-json/wp/v2/posts?per_page=75&_embed',
    'Persekutuan Oikumene (PO)' => 'https://student-activity.binus.ac.id/po/wp-json/wp/v2/posts?per_page=75&_embed',
    'Primary Teacher Education (PGSD) - Faculty of Humanities' => 'https://pgsd.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Psychology - Faculty of Humanities' => 'https://psychology.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Seni Tari Mahasiswa Bina Nusantara (STAMANARA)' => 'https://student-activity.binus.ac.id/stamanara/wp-json/wp/v2/posts?per_page=75&_embed',
    'Seni Teater Mahasiswa Bina Nusantara (STMANIS)' => 'https://student-activity.binus.ac.id/stmanis/wp-json/wp/v2/posts?per_page=75&_embed',
    'School of Computer Science (SOCS)' => 'https://socs.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'School of Information Systems (SIS)' => 'https://sis.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Student BINUS' => 'https://student.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Student Club and Activity Center (SCAC)' => 'https://student-activity.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'Teach for Indonesia (TFI)' => 'http://www.teachforindonesia.org/wp-json/wp/v2/posts?per_page=75&_embed',
    'TFI Student Committee (TFISC)' => 'https://student-activity.binus.ac.id/tfi/wp-json/wp/v2/posts?per_page=75&_embed',
    'Tourism - Faculty of Economic & Communication' => 'https://tourism.binus.ac.id/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Aikido' => 'https://student-activity.binus.ac.id/aikido/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Badminton' => 'https://student-activity.binus.ac.id/badminton/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Band' => 'https://student-activity.binus.ac.id/band/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Basket' => 'https://student-activity.binus.ac.id/basket/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Karate' => 'https://student-activity.binus.ac.id/karate/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Merpati Putih (MP)' => 'https://student-activity.binus.ac.id/mp/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Sepak Bola (BINUS Football Club)' => 'https://student-activity.binus.ac.id/sepakbola/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Taekwondo' => 'https://student-activity.binus.ac.id/taekwondo/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Volley' => 'https://student-activity.binus.ac.id/volley/wp-json/wp/v2/posts?per_page=75&_embed',
    'UKM Wushu' => 'https://student-activity.binus.ac.id/wushu/wp-json/wp/v2/posts?per_page=75&_embed',
];
